...
> #### **public** _void_ **`wrap`** (  ) ####
## `EmailElement` ##
##### <sub>class</sub> EmailElement <sub>extends</sub> [BBCodeElement](DOCLibs#BBCodeElement.md) <sup>File: libs/class.BBCodeElements.inc</sup> #####

> #### **public** _void_ **`wrap`** (  ) ####
## `LeftElement` ##
##### <sub>class</sub> LeftElement <sub>extends</sub> [BBCodeElement](DOCLibs#BBCodeElement.md) <sup>File: libs/class.BBCodeElements.inc</sup> #####

> #### **public** _void_ **`wrap`** (  ) ####
> #### **public** _void_ **`isBlock`** (  ) ####
## `RightElement` ##
##### <sub>class</sub> RightElement <sub>extends</sub> [BBCodeElement](DOCLibs#BBCodeElement.md) <sup>File: libs/class.BBCodeElements.inc</sup> #####

> #### **public** _void_ **`wrap`** (  ) ####
> #### **public** _void_ **`isBlock`** (  ) ####
## `CenterElement` ##
##### <sub>class</sub> CenterElement <sub>extends</sub> [BBCodeElement](DOCLibs#BBCodeElement.md) <sup>File: libs/class.BBCodeElements.inc</sup> #####

> #### **public** _void_ **`wrap`** (  ) ####
> #### **public** _void_ **`isBlock`** (  ) ####
## `ListElement` ##
##### <sub>class</sub> ListElement <sub>extends</sub> [BBCodeElement](DOCLibs#BBCodeElement.md) <sup>File: libs/class.BBCodeElements.inc</sup> #####

> #### **public** _void_ **`wrap`** (  ) ####
## `ItemElement` ##
##### <sub>class</sub> ItemElement <sub>extends</sub> [BBCodeElement](DOCLibs#BBCodeElement.md) <sup>File: libs/class.BBCodeElements.inc</sup> #####

> #### **public** _void_ **`wrap`** (  ) ####
> #### **public** _void_ **`singelLine`** (  ) ####
## `BBCodeException` ##
##### <sub>class</sub> BBCodeException <sub>extends</sub> Exception <sup>File: libs/class.BBCodeParser.inc</sup> #####
Exception which is triggered if something goes wrong
## `BBCodeElement` ##
##### <sub>class</sub> BBCodeElement <sup>File: libs/class.BBCodeParser.inc</sup> #####
And BBCode element which is linked to an HTML element
> #### **public** _void_ **`__construct`** ( _string_ `$type` ) ####
Constructor
> #### **public** **static** _[BBCodeElement](DOCLibs#BBCodeElement.md)_ **`init`** ( _string_ `$tag` ) ####
...
> #### **public** _[BBCodeElement](DOCLibs#BBCodeElement.md)_ **`getParent`** (  ) ####
...
> #### **public** _void_ **`addChild`** ( _[BBCodeElement](DOCLibs#BBCodeElement.md)_ `$child` ) ####
Add a Child to the element
> #### **public** _[BBCodeElement](DOCLibs#BBCodeElement.md)_ **`getLastChild`** (  ) ####
...
## `BBCodeDocument` ##
##### <sub>class</sub> BBCodeDocument <sub>extends</sub> [BBCodeElement](DOCLibs#BBCodeElement.md) <sup>File: libs/class.BBCodeParser.inc</sup> #####
BBCode Document root
> #### **public** _void_ **`__construct`** (  ) ####
Constructor
> #### **public** _string_ **`valueOf`** ( _string_ `$level`, _int_ `$i` ) ####
> Inherited from: [BBCodeElement](DOCLibs#BBCodeElement.md)
Debug for showing the element tree from this element
## `BBCodeDummyElement` ##
##### <sub>class</sub> BBCodeDummyElement <sub>extends</sub> [BBCodeElement](DOCLibs#BBCodeElement.md) <sup>File: libs/class.BBCodeParser.inc</sup> #####
...
Get the HTML, including the wrapping, of the element
## `BBCodeText` ##
##### <sub>class</sub> BBCodeText <sub>extends</sub> [BBCodeElement](DOCLibs#BBCodeElement.md) <sup>File: libs/class.BBCodeParser.inc</sup> #####
...
Get the HTML, including the wrapping, of the element
## `BBCodeNewLine` ##
##### <sub>class</sub> BBCodeNewLine <sub>extends</sub> [BBCodeElement](DOCLibs#BBCodeElement.md) <sup>File: libs/class.BBCodeParser.inc</sup> #####
...
Get the HTML, including the wrapping, of the element
## `BBCodeParagraph` ##
##### <sub>class</sub> BBCodeParagraph <sub>extends</sub> [BBCodeElement](DOCLibs#BBCodeElement.md) <sup>File: libs/class.BBCodeParser.inc</sup> #####
Element which is a paragraph in the document
> #### **public** _void_ **`__construct`** (  ) ####
Constructor
> #### **public** _void_ **`wrap`** ( _string_ `$text` ) ####
> Inherited from: [BBCodeElement](DOCLibs#BBCodeElement.md)
Wrap the content of the element
## `BBCodeUnknownElement` ##
##### <sub>class</sub> BBCodeUnknownElement <sub>extends</sub> [BBCodeElement](DOCLibs#BBCodeElement.md) <sup>File: libs/class.BBCodeParser.inc</sup> #####
...
Check if the element doesn't need a closing tag
## `BBCodeParser` ##
##### <sub>class</sub> BBCodeParser <sup>File: libs/class.BBCodeParser.inc</sup> #####
...
## `CLIAction` ##
##### _abstract_ <sub>class</sub> CLIAction <sup>File: libs/class.CLI.inc</sup> #####
CliAction interface
> #### _void_ **`setup`** ( _[CLI](DOCLibs#CLI.md)_ `$cli` ) ####
Setup function, you can override this to add setup stuff. This is
called before the exec
> #### _void_ **`cleanup`** ( _[CLI](DOCLibs#CLI.md)_ `$cli` ) ####
Cleanup function, you can override this to add cleanup stuff. This is
called after the exec
> #### **abstract** _void_ **`exec`** ( _[CLI](DOCLibs#CLI.md)_ `$cli`, _string_ `$action` ) ####
Execute the action
## `OS` ##
##### <sub>class</sub> OS <sup>File: libs/class.CLI.inc</sup> #####
...
## `CLI` ##
##### <sub>class</sub> CLI <sup>File: libs/class.CLI.inc</sup> #####
Cli main class
...
> #### **public** _void_ **`setAction`** ( _string_ `$action` ) ####
Set the action manualy
> #### **public** _void_ **`getAction`** ( _string_ `$action` ) ####
Set the action manualy
> #### **private** _void_ **`_header`** (  ) ####
Fallback when there was no header
## `CronParser` ##
##### <sub>class</sub> CronParser <sup>File: libs/class.CronParser.inc</sup> #####
...
## `FTP` ##
##### <sub>class</sub> FTP <sup>File: libs/class.FTP.inc</sup> #####
Helper class for uploading stuff using FTP
> #### **public** **static** _[FTP](DOCLibs#FTP.md)_ **`getInstance`** (  ) ####
Singelton
...
## `TableInfo` ##
##### <sub>class</sub> TableInfo <sup>File: libs/class.InstallHelper.inc</sup> #####
...
## `InstallHelper` ##
##### <sub>class</sub> InstallHelper <sup>File: libs/class.InstallHelper.inc</sup> #####
...
> #### **public** _void_ **`needsLoad`** (  ) ####
> #### **private** _void_ **`makeSQL`** (  `$content` ) ####
...
## `OAuthUtil` ##
##### <sub>class</sub> OAuthUtil <sup>File: libs/class.OAuthUtil.inc</sup> #####
OAuth helper class

NOTE: most of the code comes from the developer pages of hyves
> #### **public** **static** _string_ **`urlencodeRFC3986`** ( _string_ `$string` ) ####
URLEncode a string RFC3986
> #### **public** **static** _string_ **`urlencodeRFC3986_UTF8`** ( _string_ `$string` ) ####
URLEncode a string RFC3986 and UTF8
> #### **public** **static** _string_ **`urldecodeRFC3986`** ( _string_ `$string` ) ####
URLDecode a string RFC3986
> #### **public** **static** _string_ **`urldecodeRFC3986_UTF8`** ( _string_ `$string` ) ####
URLDecode a string RFC3986 and UTF8
> #### **public** **static** _array_ **`prepData`** ( _array_ `$sVar` ) ####
Prep the data into a multidementional array
> #### **public** **static** _string_ **`normalizeParameters`** ( _array_ `$aParam` ) ####
Normalize data and sort in alphabatic order
> #### **public** **static** _void_ **`generateBaseString`** ( _string_ `$http_method`, _string_ `$uri`, _string_ `$params` ) ####
Generate Base String for signature
> #### **public** **static** _string_ **`calculateHMACSHA1Signature`** ( _string_ `$basestring`, _string_ `$consumersecret`, _string_ `$tokensecret` ) ####
Calculate the signature HASH
> #### **public** **static** _string_ **`calculateOAuthSignature`** ( _string_ `$key`, _string_ `$data`, _string_ `$http_method`, _string_ `$uri`, _array_ `$sVar`, _string_ `$consumersecret`, _string_ `$oauth_token_secret` ) ####
